    ...
    return (
        <div>
            <div className='max-w-screen-xl mx-auto w-full min-h-[300px] relative'>
                <div className='w-full flex flex-col lg:flex-row mx-auto justify-around p-12 items-center space-y-8 lg:space-y-0'>
                    <div className='bg-gray-100 border border-gray-200 p-8 max-w-sm lg:max-w-md w-full space-y-3'>
                        ...
                        <div className='dark:text-white text-gray-800 bg-red-600 dark:bg-red-700 p-2.5 font-[owners] w-fit px-6 mx-auto hover:scale-105'>
                            <Link href=''>Apply</Link></div>
                    </div>
                    <div className='bg-gray-100 border border-gray-200 p-8 max-w-sm lg:max-w-md w-full space-y-3'>
