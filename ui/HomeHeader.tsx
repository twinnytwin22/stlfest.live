...
function HomeHeader() {
    ...
    function getNextJulySeventh() {
        ...
        nextJulySeventh.setMinutes(nextJulySeventh.getMinutes() + chicagoTimezoneOffset);
            ...
            >
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 tracking-wide relative">
                    <Link href={extLink} className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm  bg-blue-700 text-white  hover:bg-blue-900 hover:scale-105 duration-300 ease-in-out" role="alert">
                        <span className="text-xs bg-primary-600 text-white px-4 py-1.5 mr-3"><AiFillStar className='w-4 h-4 text-yellow-400' /></span> <span className="text-xl font-medium font-['owners2']">Save the date!</span>
                        <svg className="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                    </Link>
                    <Image className='max-w-xs p-12 mx-auto scale-150  duration-150 ease-in-out relative z-10' src="/images/STL-4EST-LOGO.png" alt="Logo" width={1000} height={1000}/>
                    <h1 className="font-extrabold leading-none text-6xl lg:text-8xl text-white font-[bubblegum-pop-highlight] tracking-wide">7.7.24</h1>
